...
const projects: Project[] = [
  {
    title: "Smart Cart",
    description:
      "Fast and efficient navigation in the supermarket with an interactive map that shows the shortest route to collect items.",
    imageUrl:
    ...
    technologies: ["Full-Stack", "Navigation", "React"],
    icon: Zap,
  ...
  },
  {
    ...
    description:
      "A sleek and intuitive mobile shopping experience built with React Native. Browse products, add to cart, and checkout effortlessly.",
    imageUrl:
    ...
    technologies: ["React Native", "Mobile", "E-commerce"],
    icon: Smartphone,
        ...
        <div className="relative h-56 overflow-hidden">
          ...
          >
            ...
            >
              ...
              <span className="text-gray-700 font-semibold">View Project</span>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <motion.p
            ...
            transition={{ duration: 0.8, delay: 0.8 }}
          >
            Explore my portfolio of innovative applications, from smart
            navigation systems to mobile commerce solutions
          </motion.p>
        </motion.div>
